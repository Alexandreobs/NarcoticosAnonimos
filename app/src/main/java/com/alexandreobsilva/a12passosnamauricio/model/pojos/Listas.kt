...
val listaDozeTradicoes: MutableList<PassosTradicoesConceitos> = mutableListOf(
    ...
    PassosTradicoesConceitos(
        "2º. Para o nosso propósito comum existe apenas uma autoridade — um Deus amoroso que pode se expressar na nossa consciência de grupo. Nossos líderes são apenas servidores de confiança, eles não governam.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
    ...
    PassosTradicoesConceitos(
        "5º. Cada grupo tem apenas um propósito primordial — levar a mensagem ao adicto que ainda sofre.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
    ...
    PassosTradicoesConceitos(
        "7º. Todo grupo de NA deverá ser totalmente autossustentado, recusando contribuições de fora.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
    ...
    PassosTradicoesConceitos(
        "9º. NA nunca deverá organizar-se como tal; mas podemos criar quadros ou comitês de serviço diretamente responsáveis perante aqueles a quem servem.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
        "10º. Narcóticos Anônimos não tem opinião sobre questões de fora; portanto o nome de NA nunca deverá aparecer em controvérsias públicas.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
...
val listaDozeConceitos: MutableList<PassosTradicoesConceitos> = mutableListOf(
    ...
    PassosTradicoesConceitos(
        "1º. Para cumprir o propósito primordial da nossa irmandade, os grupos de NA se uniram para criar uma estrutura que desenvolve, coordena e mantém serviços por NA como um todo.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
    ...
    PassosTradicoesConceitos(
        "5º. Para cada responsabilidade atribuída à estrutura de serviço, deve ser claramente definido apenas um ponto de decisão e prestação de contas.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
        "6º. A consciência de grupo é o meio espiritual pelo qual convidamos um Deus amoroso a influenciar nossas decisões.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
        "7º. Todos os membros de um corpo de serviço arcam com responsabilidade substancial pelas decisões desse corpo e devem poder participar plenamente nos seus processos de tomada de decisão.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
    ...
    PassosTradicoesConceitos(
        "11º. Os recursos de NA devem ser usados para promover o nosso propósito primordial e devem ser administrados com responsabilidade.",
        "adicionar"
    ),
    PassosTradicoesConceitos(
...
val listaDeOracoes: MutableList<PassosTradicoesConceitos> = mutableListOf(
    ...
    PassosTradicoesConceitos(
        "Pai Nosso", "Pai nosso, que estás nos céus!\n" +
    ...
    PassosTradicoesConceitos(
        ...
        "Senhor, ilumina meus olhos para que eu veja os defeitos da minha alma\n" +
                ...
                "Mas não a entregueis a mais ninguém…\n" +
                "\n" +
                "Encha meu coração com a divina fé,\n" +
                "Para sempre louvar o vosso nome\n" +
                "E arranque de mim o orgulho e a presunção\n" +
                "\n" +
                "Fazei de mim um ser humano realmente justo\n" +
                "Dá-me esperança para vencer todas essas ilusões terrenas\n" +
                "Planta em meu coração a semente do amor incondicional\n" +
                ...
                "Meus companheiros em meus amigos,\n" +
                ...
                "Mantendo eternamente em meu coração somente o amor."
    ),

    PassosTradicoesConceitos(
        "Abençoa o Nosso Dia Senhor!",
...
val listaDeRecaidas: MutableList<PassosTradicoesConceitos> = mutableListOf(
    ...
    PassosTradicoesConceitos(
        "1 DESONESTIDADE",
        "DESONESTIDADE: começa com mentiras nas pequenas coisas em casa. Depois vem com mentiras maiores como dar desculpas para não fazer o que deve ou para fazer o que não deve. Termina com desonestidade consigo mesmo: RECAÍDA. Principio de recuperação Honestidade."
    ),
    PassosTradicoesConceitos(
        "2 IMPACIÊNCIA",
        "IMPACIÊNCIA: exigir demais dos outros e de si. Quer tudo “pra já”. Traçar metas que não pode alcançar com esforço normal e no tempo normal. Concentrar-se só em problemas que ainda não estão completamente resolvidos. Vá com calma!"
    ),
    PassosTradicoesConceitos(
        "3 INTOLERÂNCIA",
        "INTOLERÂNCIA: discutir e disputar pequenos e ridículos pontos de vistas, achando-se dono da verdade, tendo resposta para si e para os outros. Querer que todos mudássemos a maneira de vida só porque mudou a sua. Viva e deixe viver!"
    ),
    PassosTradicoesConceitos(
        "4 INDISCIPLINA",
        "INDISCIPLINA: descuidar de horários e compromissos. Esquecer as orações, meditações, inventário moral diário. Lembre-se que nada de grandioso na vida se consegue sem sacrifícios. Não invente prioridades. Primeiro as primeiras coisas!"
    ),
    PassosTradicoesConceitos(
        "5 DEPRESSÃO",
        "DEPRESSÃO: medos e desespero inexplicáveis e irracionais devem ter suas causas identificadas e combatidas, fale no grupo ou procure orientação médica. Olhe a vida também pelo lado positivo. Acredite em si, aposte em si!"
    ),
    PassosTradicoesConceitos(
        "6 FRUSTRAÇÃO",
        "FRUSTRAÇÃO: alimentar desencanto com pessoas e coisas que não estão sendo favoráveis. Lembre-se que nem tudo é exatamente como se quer. “Felicidade não é ter o que se quer, mas amar o que se tem”."
    ),
    PassosTradicoesConceitos(
        "7 EUFORIA",
        "EUFORIA: achar que é impossível ficar melhor do que já esta... que o progresso, o sucesso é estupendo, que por isso “é bobagem se cuidar tanto”. A displicência sempre aparece quando tudo vai muito bem e é aí que ocorre, um grande numero de recaídas. Cultive a moderação, mantenha seu equilíbrio emocional!"
    ),
    PassosTradicoesConceitos(
        "8 EXAUSTÃO",
        "EXAUSTÃO: discipline horários de trabalho e lazer. Não se canse demais, proteja a saúde. Se sentir bem, mais chance terá de pensar bem!\n"
    ),
    PassosTradicoesConceitos(
        "9 TROCA DE DEPENDÊNCIA",
        "TROCA DE DEPENDÊNCIA: substituir o álcool ou droga por tranquilizantes ou tóxico por álcool; é mera troca de dependência, é estar trapaceando consigo mesmo. É a maneira mais sutil para uma recaída. Cuidado com a auto-suficiência!"
    ),
    PassosTradicoesConceitos(
        "10 AUTOPIEDADE",
        "AUTOPIEDADE: julgar suas falhas de forma benevolente, justificando-se sempre. Lamentar-se “por que as coisas só acontecem comigo?” ou “ninguém dá valor no que faço”. Buscar desculpas no fato de ser dependente. Não sou melhor do que ninguém, não faça comparações com ninguém!"
    ),
    PassosTradicoesConceitos(
        "11 PRETENSÃO",
        " PRETENSÃO: “estou curado, não tenho mais medo de álcool ou outras drogas. Qualquer um pode recair menos eu”. “frequentar lugares da ativa, para provar aos outros que não tem problemas”, faz perder totalmente as defesas. Vale o mesmo para quem já sabe tudo sobre alcoolismo ou drogadição. Lembre-se sempre nossa doença é incurável!"
    ),
    PassosTradicoesConceitos(
...
val listaDozePassosAA: MutableList<PassosTradicoesConceitos> = mutableListOf(
    ...
    PassosTradicoesConceitos(
        ...
        "A partir do momento em que lê o Segundo Passo, a maioria dos novos em A.A. enfrenta um dilema, às vezes, bastante sério.segundo passo\n" +
                "\n" +
    ...
    PassosTradicoesConceitos(
        ...
        "A Criação nos deu os instintos por alguma razão. Sem eles não seríamos seres humanos completos. Se os homens e as mulheres não se esforçassem a fim de se sentir seguros, a fim de conseguir alimento ou construir abrigo, não sobreviveriam; se não se\n" +
                "reproduzissem, a Terra não seria povoada; se não existisse o instinto social, se os homens não se interessassem pelo convívio com seus semelhantes, não haveria sociedade. Portanto, estes desejos - pela relação sexual, pela segurança material e emocional, e pelo companheirismo - são perfeitamente necessários e naturais, e certamente dados a nós por Deus.\n" +
                "\n" +
    ...
    PassosTradicoesConceitos(
        ...
        "Já que este passo trata tão especificamente da humildade, deveríamos fazer uma pausa aqui para pensar sobre o que é a humildade e o que a sua prática poderá significar para nós.\n" +
                "\n" +
                "setimo passoRealmente, conseguir maior humildade é o princípio fundamental de cada um dos Doze Passos de A.A., pois sem um certo grau de humildade, nenhum alcoólico poderá permanecer sóbrio.\n" +
                "\n" +
